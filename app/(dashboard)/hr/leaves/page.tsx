...
export default function HRLeavesPage() {
  ...
  const handleApprove = (id: string) => {
    ...
    logAction('APPROVE_LEAVE_REQUEST', 'LeaveRequest', `Approved leave request ID ${id}.`);
    setRequests(mockDb.getLeaveRequests());
  };
              ...
              historicalRequests.map((req) => {
                ...
                return (
                  ...
                  >
                    ...
                    {req.status === 'APPROVED' && (
                      <p className="text-[9px] text-slate-400 border-t border-slate-100 pt-2 mt-1 font-semibold">
